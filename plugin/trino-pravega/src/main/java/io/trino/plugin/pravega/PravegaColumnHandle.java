...
/**
 * Pravega specific connector column handle.
 */
public final class PravegaColumnHandle
        implements DecoderColumnHandle, Comparable<PravegaColumnHandle>
{
    ...
    /**
     * True if the column is internal to the connector and not defined by a stream definition.
     */
    private final boolean internal;

    /**
     * table may have multiple schemas (kv table, 1 for key + 1 for value)
     * to which does this column belong
     */
    private final int schemaNum;

    @JsonCreator
    public PravegaColumnHandle(
            ...
            @JsonProperty("schemaNum") int schemaNum)
    {
    ...
    public boolean equals(Object obj)
    {
        ...
        PravegaColumnHandle other = (PravegaColumnHandle) obj;
    ...
    @Override
    public int compareTo(PravegaColumnHandle otherHandle)
    {
