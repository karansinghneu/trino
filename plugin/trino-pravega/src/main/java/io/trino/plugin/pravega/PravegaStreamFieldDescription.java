...
/**
 * Json description to parse a single field from a Pravega stream message. See {@link io.trino.plugin.pravega.PravegaStreamDescription} for more details.
 */
public final class PravegaStreamFieldDescription
{
    ...
    @JsonCreator
    public PravegaStreamFieldDescription(
    ...
    PravegaColumnHandle getColumnHandle(String connectorId, boolean keyDecoder, int index, int schemaNum)
    {
    ...
    public boolean equals(Object obj)
    {
        ...
        PravegaStreamFieldDescription other = (PravegaStreamFieldDescription) obj;
