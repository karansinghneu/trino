...
import io.trino.plugin.s3.decoder.CsvRowDecoder;
...
import static io.trino.plugin.s3.S3Const.PARQUET;
import static io.trino.plugin.s3.S3HandleResolver.convertSplit;
import static io.trino.plugin.s3.S3SelectUtil.useS3Pushdown;
        ...
        implements ConnectorPageSourceProvider
{
    ...
    private static final Logger log = Logger.get(S3PageSourceProvider.class);
...
//        }
            ...
            boolean s3SelectPushdownEnabled)
    {
        ...
        List<S3PageSourceProvider.ColumnMapping> columnMappings = S3PageSourceProvider.ColumnMapping.buildColumnMappings(
                allColumns);
    ...
    public static class ColumnMapping
    {
        ...
        public static S3PageSourceProvider.ColumnMapping regular(S3ColumnHandle s3ColumnHandle, int index)
        {
            return new S3PageSourceProvider.ColumnMapping(s3ColumnHandle, OptionalInt.of(index));
        }
