...
public class S3TableDescriptionSupplier
        implements Supplier<Map<SchemaTableName, S3Table>>
{
    private static final Logger log = Logger.get(S3TableDescriptionSupplier.class);
