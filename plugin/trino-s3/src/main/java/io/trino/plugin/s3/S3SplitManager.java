...
import static io.trino.plugin.s3.S3Const.*;
import static io.trino.plugin.s3.S3Util.intProp;
import static io.trino.plugin.s3.Types.checkType;
        ...
        implements ConnectorSplitManager
{
            ...
            DynamicFilter dynamicFilter)
    {
        ...
        S3TableLayoutHandle layoutHandle = checkType(table, S3TableLayoutHandle.class, "layout");
