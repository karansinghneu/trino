        ...
        implements Serializable
{
    ...
    public static byte[] serialize(S3ObjectRange objectRange)
    {
        try {
    ...
    public static S3ObjectRange deserialize(byte[] objectRangeBytes)
    {
        try {
            ByteArrayInputStream bais = new ByteArrayInputStream(objectRangeBytes);
            ObjectInputStream bis = new ObjectInputStream(bais);
            return (S3ObjectRange) bis.readObject();
        }
        catch (IOException e) {
            throw new UncheckedIOException(e);
        }
