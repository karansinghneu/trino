...
public class S3ConnectorConfig
{
    ...
    public S3ConnectorConfig setS3SchemaFileLocationDir(String S3SchemaFileLocationDir)
    {
    ...
    @Config("s3.s3Port")
    public S3ConnectorConfig setS3Port(int S3Port)
    {
        this.S3Port = S3Port;
    ...
    public S3ConnectorConfig setS3UserKey(String S3UserKey)
    {
    ...
    @ConfigSecuritySensitive
    public S3ConnectorConfig setS3UserSecretKey(String S3UserSecretKey)
    {
    ...
    @Config("s3.s3Nodes")
    public S3ConnectorConfig setS3Nodes(String nodes)
    {
    ...
    public S3ConnectorConfig setSchemaRegistryServerIP(String SchemaRegistryServerIP)
    {
    ...
    public S3ConnectorConfig setSchemaRegistryServerPort(int SchemaRegistryServerPort)
    {
    ...
    public S3ConnectorConfig setSchemaRegistryServerNamespace(String SchemaRegistryServerNamespace)
    {
    ...
    public S3ConnectorConfig setMaxConnections(int maxConnections)
    {
    ...
    public S3ConnectorConfig setS3SocketTimeout(int s3SocketTimeout)
    {
    ...
    public S3ConnectorConfig setS3ConnectionTimeout(int s3ConnectionTimeout)
    {
    ...
    public S3ConnectorConfig setS3ClientExecutionTimeout(int s3ClientExecutionTimeout)
    {
    ...
    private static ImmutableSet<HostAddress> parseNodes(String S3Nodes)
    {
        ...
        return ImmutableSet.copyOf(transform(splitter.split(S3Nodes), S3ConnectorConfig::toHostAddress));
    }
